"""Fix the thermodynamic section in the real-time monitor"""
...
if old_section in content:
    ...
    print("Fixed formatting issue!")
else:
    print("Section not found - checking for simpler pattern")
