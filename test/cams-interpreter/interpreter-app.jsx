...
function SignalItem({ signal, index }) {
  return React.createElement('div', { style: { padding: '10px 0', borderTop: index > 0 ? '1px solid var(--paper-3)' : 'none' } },
    ...
    signal.mappings && signal.mappings.length > 0 && React.createElement('div', { style: { marginTop: 4, display: 'flex', flexDirection: 'column', gap: 2 } },
      signal.mappings.map((m, mi) => React.createElement('div', { key: mi, style: { display: 'flex', gap: 6, alignItems: 'baseline' } },
    ...
    !signal.mappings && signal.mapping && React.createElement('div', { style: { display: 'flex', gap: 6, alignItems: 'baseline' } },
...
function RefTableA() {
  ...
  return React.createElement('table', { style: { width: '100%', borderCollapse: 'collapse' } },
    React.createElement('thead', null, React.createElement('tr', null,
      ...
      React.createElement('th', { style: th }, 'Mechanism'),
    )),
    React.createElement('tbody', null, TABLE_A.map((r, i) => React.createElement('tr', { key: i },
      ...
      React.createElement('td', { style: { ...td, color: 'var(--ink-500)', fontStyle: 'italic' } }, r.mechanism || ''),
    ))),
  );
}
